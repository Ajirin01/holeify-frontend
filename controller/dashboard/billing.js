const billingController = function($scope, $rootScope, $sessionStorage, $http, CONFIG, authService){
  $scope.task_title = $sessionStorage.task_object.title.title;
      ...
      var payload = {
          ...
          callback: function (response) {
              ...
              let task_data = {
                ...
                let transaction_id = tx_ref
                task_data = JSON.stringify(task_data)

                $http.post(CONFIG.BASE_URL.API + '/create-task-temp-data', {task_data, transaction_id}, config)
                .then(response=> {
                    console.log(response);
